...
<html>
<head>
	<title><?php echo $defaultTitle?>vPlants - Guide to Limacella</title>
	...
	?> 
        ...
        <div  id="innertext">
            ...
            <div style="margin:20px;">
            	<div class="floatimg"><img src="<?php echo $clientRoot; ?>/images.vplants/fungi/guide/LIMA/LIMAGLIS.po.jpg" width="250" height="336" alt=""></div>
