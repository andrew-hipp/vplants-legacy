...
<html>
<head>
	<title><?php echo $defaultTitle?>vPlants - Guide to Volvariella</title>
	...
	?> 
        ...
        <div  id="innertext">
            ...
            <div style="margin:20px;">
            	<div class="floatimg"><img src="<?php echo $clientRoot; ?>/images.vplants/fungi/guide/VOLV/VOLV.po.jpg" width="250" height="336" alt=""></div>
