	...
	?> 
        ...
        <div  id="innertext">
            ...
            <div style="margin:20px;">
            	<p>Plants, fungi, and other organisms have different <a href="distribution.html">distribution</a> patterns and ranges. In a particular place, such as the Chicago Region, the life that occurs there can be placed in several categories based on origin and lifestyle:
