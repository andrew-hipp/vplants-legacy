	...
	?> 
		...
		<div id="content2"><!-- start of side content -->
			...
			<div class="box">
			 ...
			 <a href="map.php" title="See State Map for Chicago Region."><img class="border" src="<?php echo $clientRoot; ?>/images.vplantsimg/map_grtlakes_250.jpg" width="250" height="212"
