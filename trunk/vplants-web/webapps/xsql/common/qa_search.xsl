...
<xsl:variable name="searchType">
  <xsl:choose>
    <xsl:when test="/page/SEARCH/TYPE = 'Advanced'">
      <xsl:text>1</xsl:text>
    </xsl:when>
    <xsl:otherwise>
      <xsl:text>0</xsl:text>
...
<xsl:value-of select="/page/directory"/>
</xsl:variable>

<xsl:variable name="lname">
<xsl:value-of select="/page/SEARCH/PARAMETERS/lname"/>
</xsl:variable>

<xsl:variable name="fname">
<xsl:value-of select="/page/SEARCH/PARAMETERS/fname"/>
</xsl:variable>

<xsl:variable name="year">
<xsl:value-of select="/page/SEARCH/PARAMETERS/year"/>
</xsl:variable>

<xsl:variable name="month">
<xsl:value-of select="/page/SEARCH/PARAMETERS/month"/>
</xsl:variable>

<xsl:variable name="day">
<xsl:value-of select="/page/SEARCH/PARAMETERS/day"/>
</xsl:variable>

<xsl:variable name="state">
<xsl:value-of select="/page/SEARCH/PARAMETERS/state"/>
</xsl:variable>

<xsl:variable name="county">
<xsl:value-of select="/page/SEARCH/PARAMETERS/county"/>
</xsl:variable>

<xsl:variable name="city">
<xsl:value-of select="/page/SEARCH/PARAMETERS/city"/>
</xsl:variable>

<xsl:variable name="twp">
<xsl:value-of select="/page/SEARCH/PARAMETERS/twp"/>
</xsl:variable>

<xsl:variable name="range">
<xsl:value-of select="/page/SEARCH/PARAMETERS/range"/>
</xsl:variable>

<xsl:variable name="section">
<xsl:value-of select="/page/SEARCH/PARAMETERS/section"/>
</xsl:variable>

<xsl:variable name="filter">
<xsl:value-of select="/page/SEARCH/PARAMETERS/filter"/>
</xsl:variable>

<xsl:variable name="infrasp">
<xsl:value-of select="/page/SEARCH/PARAMETERS/infrasp"/>
</xsl:variable>

<xsl:variable name="locality">
<xsl:value-of select="/page/SEARCH/PARAMETERS/locality"/>
</xsl:variable>

<xsl:variable name="habitat">
<xsl:value-of select="/page/SEARCH/PARAMETERS/habitat"/>
</xsl:variable>

<xsl:variable name="substratum">
<xsl:value-of select="/page/SEARCH/PARAMETERS/substratum"/>
</xsl:variable>

<xsl:template match="/">
<html>
<head>
<title>vPlants | <xsl:value-of select="/page/SEARCH/TYPE"/> Search Results
 for <xsl:value-of select="/page/directory"/> 
</title>
    ...
    <tr>
      ...
      <td width="610" valign="top">
        <table width="450" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><h1>
<xsl:value-of select="/page/SEARCH/TYPE"/> Search Results
 for <xsl:value-of select="/page/directory"/> 
            </h1></td>
          </tr>
          <tr>
...
<xsl:choose>
  <xsl:when test='$searchType = "0"'>
	...
	<xsl:apply-templates/>
<div class="choices">
	<a href="/xsql/{$db}/taxon.xsql?gid={GROUP_ID}">All Specimens.</a>
<span> | </span>
	<a href="/{$db}/speciesqa/species.jsp?gid={GROUP_ID}">QA DESCRIPTION.</a>
<span> |  </span> 
