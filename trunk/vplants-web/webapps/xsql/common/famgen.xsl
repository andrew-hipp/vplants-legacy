    ...
    <tr>
      ...
      <td width="610" valign="top">
        <table width="450" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><h1>Browse Genus List for <xsl:value-of select="fam"/></h1></td>
          </tr>
          <tr>
            <td valign="top">
          	  <a href="famtaxa.xsql?fam={fam}">Taxon List for <xsl:value-of select="fam"/></a><br/><br/>
...
<xsl:template match="GENUS">
  <tr>
    ...
    <td width="99%" class="browseListText">
      <a href="gentaxa.xsql?gen={.}">
      <xsl:value-of select="."/>
      </a>
    </td>
  </tr>
