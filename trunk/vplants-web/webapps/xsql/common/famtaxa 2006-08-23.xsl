...
<xsl:template match="/page/SNIDX">
<html>
<head>
<title>vPlants | Browse Family List: <xsl:value-of select="fam"/></title>
    ...
    <tr>
      ...
      <td width="610" valign="top">
        <table width="450" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><h1>
Browse Family List: <xsl:value-of select="fam"/>
            </h1></td>
          </tr>
          <tr>
            <td valign="top">
