...
public class FloweringTag extends TagSupport 
{
  ...
  public int doStartTag() throws JspException
  {
    try
    {
      ...
      if (data.getFlowering() != null && !data.getFlowering().equalsIgnoreCase("")){
        output.append("<dt id='season'>Flowering:</dt> <dd>"+data.getFlowering()+"</dd>");
      }
