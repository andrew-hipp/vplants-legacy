...
public class LinksTypeImpl implements org.vplants.utils.jaxb.LinksType, com.sun.xml.bind.JAXBObject, org.vplants.utils.jaxb.impl.runtime.UnmarshallableObject, org.vplants.utils.jaxb.impl.runtime.XMLSerializable, org.vplants.utils.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.vplants.utils.jaxb.LinksType.class);
    }
    ...
    public org.vplants.utils.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.vplants.utils.jaxb.impl.runtime.UnmarshallingContext context) {
        return new org.vplants.utils.jaxb.impl.LinksTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Link.get(idx1) instanceof javax.xml.bind.Element) {
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Link.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Link.get(idx1 ++)), "Link");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Link.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Link.get(idx1 ++)), "Link");
            } else {
                idx1 += 1;
            }
        }
...
+"\u0000\u001borg.vplants.utils.jaxb.Linkt\u0000+http://java.sun.com/jaxb/xjc"
+"/dummy-elementssq\u0000~\u0000\tpp\u0000sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0007ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0010psq\u0000~\u0000\u0011q\u0000~\u0000\u0010pq"
+"\u0000~\u0000\u0014q\u0000~\u0000\u0018q\u0000~\u0000\u001asq\u0000~\u0000\u001bt\u0000\u001forg.vplants.utils.jaxb.LinkTypeq\u0000~\u0000\u001fs"
...
+"/2001/XMLSchema-instanceq\u0000~\u0000\u001asq\u0000~\u0000\u001bt\u0000\u0004linkt\u0000\u0000sr\u0000\"com.sun.msv"
...
+"\u0000\u000eq\u0000~\u0000%q\u0000~\u0000\bq\u0000~\u0000\"q\u0000~\u0000)q\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000$x"));
        ...
        extends org.vplants.utils.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.vplants.utils.jaxb.impl.LinksTypeImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        if (("linkUri" == ___local)&&("" == ___uri)) {
                            _getLink().add(((org.vplants.utils.jaxb.impl.LinkTypeImpl) spawnChildFromEnterElement((org.vplants.utils.jaxb.impl.LinkTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  1 :
                        if (("link" == ___local)&&("" == ___uri)) {
                            _getLink().add(((org.vplants.utils.jaxb.impl.LinkImpl) spawnChildFromEnterElement((org.vplants.utils.jaxb.impl.LinkImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("link" == ___local)&&("" == ___uri)) {
