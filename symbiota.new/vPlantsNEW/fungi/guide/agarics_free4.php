...
<html>
<head>
	<title><?php echo $defaultTitle?>vPlants - Guide to Agarics Gills Free Key 4</title>
	...
	?> 
        ...
        <div  id="innertext">
            ...
            <div style="margin:20px;">
				...
				<td><div><img src="<?php echo $clientRoot; ?>/images.vplants/fungi/guide/LEPI2/LEPI2_300_whole.jpg" width="300" height="222" alt=""></div>
				<p>
				</p>
				</td>
				</tr>
