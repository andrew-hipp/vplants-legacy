	...
	?> 
        ...
        <div  id="innertext">
            ...
            <div style="margin:20px;">
				...
				<dt><a href="names2.html">Scientific names</a></dt><dd> are official names that follow rules of taxonomy to uniquely identify a taxon, such as a species or family. Example: <i>Ulmus americana</i> and <i>Ulmaceae</i>.</dd>
				<dt><a href="names3.html">Synonyms</a></dt><dd> are different names for the same taxon. Example: <i>Ulmus floridana</i> is a synonym of <i>Ulmus americana</i>.</dd>
				<dt><a href="names4.html">Common names</a></dt><dd> are nicknames that vary between regions and languages. They follow no rules and often are not unique. Example: American elm.</dd></dl></p>
