...
/**
  * Insert query bean for the LOCALITY table.
  * <P>
  * @author Matthew Schaub
  */
public class LocInsQuery extends QueryObject {
    static final String INS_QUERY = "INSERT INTO LOCALITY " +
"( " +
"SPM_ID, " +
"HERB_CD, " +
"LOCALITY, " +
...
/**
  ...
  */
  public LocInsQuery(Connection conn)
      throws SQLException {
  ...
  */
  public void executeQuery(String herbCd, String spmId,
      ...
      try {
          ...
          statement.setString(LOCALITY_I, locality);
