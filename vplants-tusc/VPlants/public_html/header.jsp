...
<head>
<title>vPlants - Gentiana andrewsii var. andrewsii - Description</title>
...
<link rel="search" title="Search this site" http://www.vplants.org/search.html">
...
<div id="logo"><a tabindex="2" 
 ...
 title="vPlants.org Home."><img src="logo.gif" 
...
<ul id="taxtabs"><li><a tabindex="200" 
 href="/xsql/vplants/snidx.xsql?fam=Gentianaceae" 
 title="Go to listing for this Family.">Plant<!-- insert GROUP --> Family:  
 <strong>Gentianaceae</strong></a></li><li><a 
 href="/xsql/vplants/gensn.xsql?gen=Gentiana" 
 title="Go to listing for this Genus.">Genus:  
<strong>Gentiana</strong></a></li></ul>

<ul id="viewtabs"><li><a 
 href="/xsql/vplants/taxon.xsql?gid=17578"
 title="All Specimens for this plant.">Specimens</a></li><li
 class="thispage"><span 
 title="You are here: Description for this plant.">Description</span></li><li><a 
 href="#"
 title="Photo Gallery for this plant.">Photos</a></li></ul>
</div><!-- End of #tabs -->
...
<h2 class="taxon">
 <span class="sp">
  <em class="genus">Gentiana</em> 
  <em class="epithet">andrewsii</em> 
  <span class="author">Griseb.</span>
 </span>
...
<dt id="synonym">Synonyms:</dt>
<dd>
 <em>Dasystephana andrewsii</em> (Griseb.) Small;
 <em>Pneumonanthe andrewsii</em> (Griseb.) W.A. Weber  
</dd>

<dt id="desc">Description:</dt>
<dd>
 <dl id="descdef">
  <dt class="growth">Growth form:</dt>
   <dd class="growth">Perennial herb,</dd>
  <dt class="size">Size:</dt>
   <dd class="size">10 cm - 1.2 m tall.</dd>
  <dt class="part">Stem</dt>
   <dd class="part">usually unbranched, hairless.</dd>
  <dt class="part">Leaves</dt>
   <dd class="part">opposite, stalkless, somewhat lance-shaped (3 - 15 cm long, up to 4 cm wide), with somewhat long pointed tips, and rough or prickly-hairy margins.</dd>
  <dt class="part">Flowers</dt>
   <dd class="part">(1 - 25) stalkless, bluish violet to pinkish violet, closed, club-shaped, and clustered at the top of the stem and often in the axils of the upper leaves.</dd>
  <dt class="part">Sepals</dt>
   <dd class="part">five but joined to longer, toothed or jagged-edged whitish membranes (plaits) between the actual petals.</dd>
  <dt class="part">Petals</dt>
   <dd class="part">five but fused together.</dd>
  <dt class="part">Anthers</dt>
   <dd class="part">fused together.</dd>
  <dt class="part">Fruit</dt>
   <dd class="part">a two-valved, elliptic capsule with numerous flattened, winged, smooth seeds.</dd>
 </dl><!-- End #defdesc -->
</dd>

<dt id="simsp">Similar species:</dt> 
<dd>
There are two other species of closed gentians in our area that may be confused with <em>Gentiana andrewsii</em> var. <em>andrewsii</em>.  <em>Gentiana alba</em> differs by having whitish flowers and completely smooth leaf margins and sepal tips.  <em>Gentiana saponaria</em> has much narrower leaves (less than 2 cm wide) with shorter, not long pointed tips, and the free part of the sepals are almost as long as the connected tube portion.  In addition to this variety of <em>G. andrewsii</em>, the more western variety, <em>G. andrewsii</em> var. <em>dakotica</em>, has been found here though it is extremely rare.  The western variety can be distinguished by its better-developed petal tips, which are triangular to rounded and often have a free, pointed tip up to 3 mm long.
</dd>
<!-- insert taxon names for Similar Species name codes and link to their description page URL -->
<dd class="simlink">
<a href="#GEAL4">Gentiana alba</a>
</dd>
<dd class="simlink">
<a href="#GESA">Gentiana saponaria</a>
</dd>
<dd class="simlink">
<a href="#GEAN">Gentiana andrewsii</a>
</dd>
<dd class="simlink">
<a href="#GEAND">Gentiana andrewsii var. dakotica</a>
</dd>

<dt id="season">Flowering:</dt>
<dd> 
August to October.
</dd>

<dt id="habitat">Habitat and ecology:</dt> 
<dd>
Occasional in damp prairies, wet meadows, and other moist open ground.
</dd>

<dt id="notes">Notes:</dt> 
<dd>
The only observed pollinators for this gentian are bumblebees, which appear to be the only insects strong enough and smart enough to open the closed flowers (Costelloe 1988).
</dd>

<dt id="etym">Etymology:</dt> 
<dd> 
<em>Gentiana</em> is named after Gentius, king of Illyria, who supposedly discovered a medicinal value for the yellow gentian. <em>Andrewsii</em> is named after the English botanical artist Henry C. Andrews.
</dd>

<dt id="native">Regional occurrence:</dt>
<dd>
<a href="/plants/concern.html" title="Read about native, non-native and invasive plants.">native</a>.
</dd>
...
g<dd class="links">
<a href="http://botany.wisc.edu/wisflora/scripts/detail.asp?SpCode=GENANDvAND">Wisconsin State Herbarium, UW - Madison</a>
</dd>
<dd class="links">
<a href="http://wisplants.uwsp.edu/scripts/detail.asp?SpCode=GENANDvAND">Freckmann Herbarium, UW - Stevens Point</a>
</dd>
<dd class="links">
<a href="http://plants.usda.gov/cgi_bin/plant_profile.cgi?symbol=GEANA">
USDA PLANTS Profile</a>, Includes USA map, state map links
</dd>
<dd class="google">Google: 
<a href="http://www.google.com/search?hl=en&amp;ie=UTF-8&amp;oe=UTF-8&amp;q=Gentiana andrewsii andrewsii&amp;btnG=Google+Search" >Text Search</a>
 |
<a href="http://images.google.com/images?q=Gentiana andrewsii andrewsii&amp;ie=UTF-8&amp;oe=UTF-8&amp;hl=en&amp;btnG=Google+Search" >Image Search</a>
</dd>
<dd>
[ We can not vouch for content of other websites ]
</dd>

<dt class="refer">References:</dt>
<dd class="refer">
Costelloe, B. H. 1988. Pollination ecology of <em>Gentiana  andrewsii</em>. Ohio Journal of Science 88:132-138.
</dd>
<dd class="refer">
Pringle, J. S. 1967. Taxonomy of <em>Gentiana,</em> section <em>Pneumonanthae</em>, in eastern North America. Brittonia. 19:1-32. 
</dd>
<dd class="refer">
Voight, J. W. and R. H. Mohlenbrock. 1985. <cite>Prairie plants of Illinois.</cite> Springfield: Illinois Department of Conservation, Division of Forest Resources and Natural Heritage.
</dd>
...
<div id="portrait"><a tabindex="400" href="#" 
 title="Go to Photo Gallery."><img
 src="geana.po.jpg" 
 alt="Gentiana andrewsii var. andrewsii"
 width="250" height="341" /></a></div>
...
<p>
<a href="/xsql/vplants/taxon.xsql?gid=17578">
...
<ul><li 
 ...
 href="/links.html"
 title="Links to related web sites.">Links</a></li></ul>
...
<area shape="rect" alt="Walworth County, Wisconsin" title="Walworth County, Wisconsin, see specimens" 
 coords="26,39,52,64" 
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=WI&amp;county=walworth" 
  />
<area shape="rect" alt="Waukesha County, Wisconsin" title="Waukesha County, Wisconsin, see specimens" 
 coords="41,9,66,36" 
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=WI&amp;county=waukesha" 
  />
...
<area shape="poly" alt="Cook County, Illinois" title="Cook County, Illinois, see specimens" 
 ...
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=cook" 
  />
...
<area shape="rect" alt="DuPage County, Illinois" title="DuPage County, Illinois, see specimens" 
 ...
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=dupage" 
  />
...
<area shape="rect" alt="Kane County, Illinois" title="Kane County, Illinois, see specimens" 
 coords="35,96,54,131" 
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=kane" 
  />
<area shape="poly" alt="Kankakee County, Illinois" title="Kankakee County, Illinois, see specimens" 
 ...
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=kankakee" 
  />
...
<area shape="rect" alt="Lake County, Illinois" title="Lake County, Illinois, see specimens" 
 coords="62,67,84,93" 
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=lake" 
  />
<area shape="rect" alt="McHenry County, Illinois" title="McHenry County, Illinois, see specimens"
 coords="29,68,59,93" 
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IL&amp;county=mchenry" 
  /> 
...
<area shape="poly" alt="Lake County, Indiana"  title="Lake County, Indiana, see specimens"  
 ...
 href="/xsql/vplants/advtaxon.xsql?gid=17578&amp;state=IN&amp;county=lake" 
  />
