...
public class EtymologyImpl
    extends org.vplants.utils.jaxb.impl.EtymologyTypeImpl
    implements org.vplants.utils.jaxb.Etymology, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.vplants.utils.jaxb.impl.runtime.UnmarshallableObject, org.vplants.utils.jaxb.impl.runtime.XMLSerializable, org.vplants.utils.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.vplants.utils.jaxb.Etymology.class);
    }
    ...
    public org.vplants.utils.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.vplants.utils.jaxb.impl.runtime.UnmarshallingContext context) {
        return new org.vplants.utils.jaxb.impl.EtymologyImpl.Unmarshaller(context);
    }
...
+"sq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\tetymo"
+"logyq\u0000~\u00009sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
...
+"pressionPool;xp\u0000\u0000\u0000\u000e\u0001pq\u0000~\u0000\tq\u0000~\u0000@q\u0000~\u0000Mq\u0000~\u0000;q\u0000~\u0000Jq\u0000~\u0000%q\u0000~\u0000Qq\u0000~\u0000"
+"Uq\u0000~\u0000\fq\u0000~\u0000\nq\u0000~\u0000\u0010q\u0000~\u0000=q\u0000~\u0000Lq\u0000~\u0000:x"));
        }
        ...
        extends org.vplants.utils.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.vplants.utils.jaxb.impl.EtymologyImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("comments" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((org.vplants.utils.jaxb.impl.EtymologyTypeImpl)org.vplants.utils.jaxb.impl.EtymologyImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((org.vplants.utils.jaxb.impl.EtymologyTypeImpl)org.vplants.utils.jaxb.impl.EtymologyImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((org.vplants.utils.jaxb.impl.EtymologyTypeImpl)org.vplants.utils.jaxb.impl.EtymologyImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((org.vplants.utils.jaxb.impl.EtymologyTypeImpl)org.vplants.utils.jaxb.impl.EtymologyImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((org.vplants.utils.jaxb.impl.EtymologyTypeImpl)org.vplants.utils.jaxb.impl.EtymologyImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
