...
public class FurtherInfoImpl
    extends org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl
    implements org.vplants.utils.jaxb.FurtherInfo, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.vplants.utils.jaxb.impl.runtime.UnmarshallableObject, org.vplants.utils.jaxb.impl.runtime.XMLSerializable, org.vplants.utils.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.vplants.utils.jaxb.FurtherInfo.class);
    }
    ...
    public org.vplants.utils.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.vplants.utils.jaxb.impl.runtime.UnmarshallingContext context) {
        return new org.vplants.utils.jaxb.impl.FurtherInfoImpl.Unmarshaller(context);
    }
...
+"\u0000~\u0000\u0004sq\u0000~\u0000\u000e\u0001q\u0000~\u00005sq\u0000~\u0000/t\u0000\bcommentst\u0000\u0000q\u0000~\u00005sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000bq\u0000~\u0000\u000f"
+"psq\u0000~\u0000\u0000q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\u000bppsr\u0000 com.sun.msv.grammar.OneOrMoreExp\u0000\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000"
+"~\u0000\u0003xq\u0000~\u0000\u0004q\u0000~\u0000\u000fpsq\u0000~\u0000&q\u0000~\u0000\u000fpsr\u00002com.sun.msv.grammar.Expressio"
+"n$AnyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004q\u0000~\u00006q\u0000~\u0000Csr\u0000 com.sun."
+"msv.grammar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00000q\u0000~\u00005sq\u0000~\u0000/t\u0000\u001corg.v"
+"plants.utils.jaxb.Linkst\u0000+http://java.sun.com/jaxb/xjc/dummy"
+"-elementssq\u0000~\u0000\u0000q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000>q\u0000~\u0000\u000fps"
+"q\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000Cq\u0000~\u0000Eq\u0000~\u00005sq\u0000~\u0000/t\u0000 org.vplants.utils.jaxb.Li"
+"nksTypeq\u0000~\u0000Hsq\u0000~\u0000\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0005link"
+"sq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u000bfurth"
+"erInfoq\u0000~\u00009sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001"
...
+"ExpressionPool;xp\u0000\u0000\u0000\u000e\u0001pq\u0000~\u0000\tq\u0000~\u0000@q\u0000~\u0000Mq\u0000~\u0000;q\u0000~\u0000Jq\u0000~\u0000%q\u0000~\u0000Qq\u0000"
+"~\u0000Uq\u0000~\u0000\fq\u0000~\u0000\nq\u0000~\u0000\u0010q\u0000~\u0000=q\u0000~\u0000Lq\u0000~\u0000:x"));
        }
        ...
        extends org.vplants.utils.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.vplants.utils.jaxb.impl.FurtherInfoImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("comments" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl)org.vplants.utils.jaxb.impl.FurtherInfoImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl)org.vplants.utils.jaxb.impl.FurtherInfoImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("furtherInfo" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl)org.vplants.utils.jaxb.impl.FurtherInfoImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl)org.vplants.utils.jaxb.impl.FurtherInfoImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((org.vplants.utils.jaxb.impl.FurtherInfoTypeImpl)org.vplants.utils.jaxb.impl.FurtherInfoImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
